...
#define PUQ_LP MT(MOD_LALT, DE_A)
#define PUQ_L1 DE_X
#define PUQ_L2 DE_C
#define PUQ_L3 DE_V
#define PUQ_L4 DE_S
...
#define PUQ_L8 DE_E
#define PUQ_L9 DE_R
#define PUQ_LA MT(MOD_LCTL|MOD_LALT|MOD_LGUI, DE_T)
#define PUQ_LB MT(MOD_LCTL, DE_G)
#define PUQ_LS MT(MOD_LSFT, KC_SPACE)
#define PUQ_LE MT(MOD_LGUI, KC_ESCAPE)
// #define PUQ_RP MT(MOD_LALT, DE_H)
#define PUQ_RP C(KC_F13) // quick-compose key. add SHIFT for full compose key
#define PUQ_R1 DE_M
...
#define PUQ_R8 DE_I
#define PUQ_R9 DE_O
#define PUQ_RA MT(MOD_LCTL|MOD_LALT|MOD_LGUI, DE_Z)
#define PUQ_RB MT(MOD_LCTL, DE_H)
...
#define COMBO_PUQ_02_ACTION DE_B
...
#define COMBO_PUQ_14_ACTION DE_P
