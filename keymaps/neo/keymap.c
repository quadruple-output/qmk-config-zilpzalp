...
#define PUQ_LP MT(MOD_LALT, DE_U)
#define PUQ_L1 C(KC_F13) // quick-compose key. add SHIFT for full compose key
#define PUQ_L2 DE_UNDS
#define PUQ_L3 DE_P
#define PUQ_L4 DE_I
#define PUQ_L5 DE_A
#define PUQ_L6 DE_E
...
#define PUQ_L8 DE_L
#define PUQ_L9 DE_C
#define PUQ_LA MT(MOD_LCTL|MOD_LALT|MOD_LGUI, DE_W)
#define PUQ_LB MT(MOD_LCTL, DE_O)
#define PUQ_LS MT(MOD_LSFT, KC_SPACE)
#define PUQ_LE MT(MOD_LGUI, KC_ESCAPE)
#define PUQ_RP MT(MOD_LALT, DE_D)
#define PUQ_R1 DE_M
#define PUQ_R2 DE_COMM
#define PUQ_R3 DE_DOT
#define PUQ_R4 DE_N
#define PUQ_R5 DE_R
#define PUQ_R6 DE_T
#define PUQ_R7 DE_H
